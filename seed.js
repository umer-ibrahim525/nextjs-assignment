...
// MongoDB Connection
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://localhost:27017/next-admin";
...
const sampleProducts = [
  {
    ...
    price: 999,
    description:
      "The latest flagship smartphone from Apple with titanium design, A17 Pro chip, and advanced camera system.",
    image:
  ...
  },
  {
    ...
    price: 1199,
    description:
      "13-inch laptop with M3 chip, stunning Retina display, and up to 18 hours of battery life.",
    image:
  ...
  },
  {
    ...
    price: 249,
    description:
      "Active Noise Cancellation, Adaptive Audio, and personalized Spatial Audio for immersive listening.",
    image:
  ...
  },
  {
    ...
    price: 429,
    description:
      "Advanced health features, fitness tracking, and always-on Retina display.",
    image:
  ...
  },
  {
    ...
    price: 1099,
    description:
      "M2 chip, Liquid Retina XDR display, and support for Apple Pencil and Magic Keyboard.",
    image:
  ...
  },
  {
    ...
    price: 1799,
    description:
      "Powerful laptop with Intel Core i9, NVIDIA RTX graphics, and stunning 4K OLED display.",
    image:
  ...
  },
  {
    ...
    price: 499,
    description:
      "Next-gen gaming console with ultra-high-speed SSD, ray tracing, and 4K gaming.",
    image:
  ...
  },
  {
    ...
    price: 299,
    description:
      "Premium wireless earbuds with personalized noise cancellation and high-fidelity audio.",
    image:
