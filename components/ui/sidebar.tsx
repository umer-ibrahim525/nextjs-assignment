...
export function MenuLink({ href, icon, badge, active, children }: MenuLinkProps) {
  return (
    <Link
      href={href}
      className={`
...
export function LogoutButton({ action = '/api/auth/signout', method = 'POST' }: LogoutButtonProps) {
  return (
